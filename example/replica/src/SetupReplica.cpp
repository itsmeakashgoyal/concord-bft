...
#include "comm-config/CommunicationConfig.hpp"
...
std::unique_ptr<SetupReplica> SetupReplica::ParseArgs(int argc, char** argv) {
  ...
  try {
    ...
    commConfig.GetReplicaConfig(replicaConfig.replicaId, keysFilePrefix, &replicaConfig);
    ...
    bft::communication::PlainTcpConfig conf =
        commConfig.GetTCPConfig(true, replicaConfig.replicaId, numOfClients, numOfReplicas);
#elif USE_COMM_TLS_TCP
    bft::communication::TlsTcpConfig conf =
        commConfig.GetTlsTCPConfig(true, replicaConfig.replicaId, numOfClients, numOfReplicas);
    ...
    bft::communication::PlainUdpConfig conf =
        commConfig.GetUDPConfig(true, replicaConfig.replicaId, numOfClients, numOfReplicas);
#endif
